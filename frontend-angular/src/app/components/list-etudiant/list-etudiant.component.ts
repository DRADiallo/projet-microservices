...
export class ListEtudiantComponent implements OnInit {
  ...
  if (this.termeRecherche) {
    // Assurez-vous que cette ligne appelle le bon service
    // etudiantService, pas classeService
    this.etudiantService.rechercherEtudiantsParPrenom(this.termeRecherche).subscribe(data => {
      // Vérifiez aussi le message du log ici
      console.log('Résultats de la recherche d\'étudiants :', data);
      this.etudiants = data;
    });
  } else {
    this.chargerEtudiants();
